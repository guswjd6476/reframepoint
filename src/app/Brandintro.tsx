...
const Brandintro = () => {
  return (
    <section
      id="about"
      className="py-24 bg-Bgreen text-white"
    >
     ...
     {/* 이미지 영역 */}
        ...
        <div className="space-y-5 text-base md:text-lg leading-relaxed">
            <p>
            <span className="font-medium text-Bgreen">ReframePoint</span>는 헬렌 켈러의 이 말을 마음에 새깁니다. 
            조건보다 그 조건을 통해 <span className="font-medium">무엇을 해내느냐</span>가 중요하니까요.
            </p>

            <p className="bg-Byellow/30 p-4 rounded-xl">
            성장의 여정은 혼자서는 완성되지 않습니다.<br />
            함께할 때 더 깊고, 넓고, 의미 있어집니다.
            </p>

            <p>
            <span className="font-medium text-Bgreen">ReframePoint</span>는 각자의 가능성과 이야기를 존중하며, 
            서로의 빛이 되어 주는 관계를 지향합니다.
            </p>

            <div className="border-l-4 border-Bgreen pl-4 text-Bblack/80 italic">
            멘토와 멘티가 함께 만드는 이 공간은<br />
