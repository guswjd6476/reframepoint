...
>
  ...
  <div className="text-white font-semibold text-3xl leading-snug z-50 mt-4 relative">
    welcome to<br />
    <span className='text-Bgreen stroke-Bbeige'>R</span>eframe <span className='text-Byellow'>P</span>oint
  </div>
 ...
 <div className="w-[390px] h-[570px] bg-white border-[10px] border-Bgreen rounded-[240px] z-20 shadow-xl flex flex-col items-center justify-center gap-4 px-6 relative">
  {/* R - 위쪽, 오른쪽으로 30도 회전 */}
  <div className="absolute top-8 text-Bgreen text-[120px] font-bold rotate-[30deg]">
    R
  </div>
  ...
  {/* P - 아래쪽, 왼쪽으로 30도 회전 */}
  <div className="absolute bottom-8 text-Bgreen text-[120px] font-bold -rotate-[40deg]">
    P
  </div>
</div>
